...
public class AllocationIdTests extends ESTestCase {
    public void testShardToStarted() {
        ...
        ShardRouting shard = ShardRouting.newUnassigned(new ShardId("test","_na_", 0), null, true, new UnassignedInfo(UnassignedInfo.Reason.INDEX_CREATED, null), RecoverySource.EXISTING_STORE);
