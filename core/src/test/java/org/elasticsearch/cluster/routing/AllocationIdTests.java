...
public class AllocationIdTests extends ESTestCase {
    public void testShardToStarted() {
        ...
        ShardRouting shard = ShardRouting.newUnassigned(new ShardId("test","_na_", 0), true, StoreRecoverySource.EXISTING_COPY_INSTANCE, new UnassignedInfo(UnassignedInfo.Reason.INDEX_CREATED, null));
