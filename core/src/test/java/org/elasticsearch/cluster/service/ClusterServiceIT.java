...
public class ClusterServiceIT extends ESIntegTestCase {
    ...
    public void testPendingUpdateTask() throws Exception {
        ...
        List<PendingClusterTask> pendingClusterTasks = clusterService.getDiscoveryService().pendingTasks();
        ...
        assertTrue(awaitBusy(() -> clusterService.getDiscoveryService().pendingTasks().isEmpty()));
        ...
        pendingClusterTasks = clusterService.getDiscoveryService().pendingTasks();
