...
public class DiskUsageTests extends ESTestCase {
    ...
    public void testFillShardsWithShadowIndices() {
        ...
        ShardRouting s0 = ShardRouting.newUnassigned(new ShardId(index, 0), null, false, new UnassignedInfo(UnassignedInfo.Reason.INDEX_CREATED, "foo"), RecoverySource.PRIMARY);
        ...
        ShardRouting s1 = ShardRouting.newUnassigned(new ShardId(index2, 0), null, false, new UnassignedInfo(UnassignedInfo.Reason.INDEX_CREATED, "foo"), RecoverySource.PRIMARY);
