 ...
 * the type of discovery. For example, for Zen discovery it is implemented by the
 * {@link PublishClusterStateAction#publish} method. The publishing mechanism can be overridden by other discovery.
 *
