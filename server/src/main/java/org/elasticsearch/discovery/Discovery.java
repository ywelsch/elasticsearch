...
public interface Discovery extends LifecycleComponent {
     ...
     */
    default void publish(ClusterChangedEvent clusterChangedEvent, ActionListener<Void> publishListener, AckListener ackListener) {
        // default implementation assumes that this is implemented in blocking fashion
        try {
            publish(clusterChangedEvent, ackListener);
