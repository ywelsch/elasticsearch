...
final class BigLongArray extends AbstractBigArray implements LongArray {
    ...
    public long increment(long index, long inc) {
        ...
        final int indexInPage = indexInPage(index);
        final LongBuffer page = pages[pageIndex];
        final long newVal = page.get(indexInPage) + inc;
    ...
    public static void fill(LongBuffer page, int from, int to, long value) {
