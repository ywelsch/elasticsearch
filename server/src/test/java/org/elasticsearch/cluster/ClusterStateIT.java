...
public class ClusterStateIT extends ESIntegTestCase {
    ...
    public static class CustomPluginCustom1 extends CustomPluginCustom {
        ...
        public Optional<String> getRequiredFeature() {
            return Optional.of("custom1-plugin");
        }
    ...
    public static class CustomPluginCustom2 extends CustomPluginCustom {
        ...
        @Override
        public Optional<String> getRequiredFeature() {
            return Optional.of("custom2-plugin");
        }
    ...
    public static class CustomPlugin1 extends CustomPlugin {
        ...
        public Settings additionalSettings() {
            final String xpackFeatureSetting = TcpTransport.FEATURE_PREFIX + "." + "custom1-plugin";
            return Settings.builder().put(super.additionalSettings()).put(xpackFeatureSetting, true).build();
        }
    }

    public static class CustomPlugin2 extends CustomPlugin {

        public static final String FEATURE_SETTING = TcpTransport.FEATURE_PREFIX + "." + "custom2-plugin";
        ...
        @Override
        protected CustomPluginCustom getInstance() {
            return new CustomPluginCustom2(13);
        }

        @Override
        public Settings additionalSettings() {
            return Settings.builder().put(super.additionalSettings()).put(FEATURE_SETTING, true).build();
        }
    }
    ...
    protected Collection<Class<? extends Plugin>> transportClientPlugins() {
        return Arrays.asList(CustomPlugin2.class); // only CustomPlugin2
    }

    @Override
    protected Settings transportClientSettings() {
        return Settings.builder().put(super.transportClientSettings())
            .put(CustomPlugin2.FEATURE_SETTING, true).build();
    }
    ...
    public void testOptionalCustoms() throws Exception {
        ...
        assertThat(keys, not(hasItem(CustomPluginCustom1.TYPE)));
        assertThat(keys, hasItem(CustomPluginCustom2.TYPE));
    }
